export function MultiSelectTag(e, t = {
    shadow: !1,
    rounded: !0
  },   selected_values) {
    var n = null,
    ...
    n = document.getElementById(e),
        function () {
            ...
            u.append(e),
                o.append(s),
                d.append(o),
                (v = document.createElement("div")).classList.add("drawer"),
        ...
        window.addEventListener("click", (e => {
            if (!a.contains(e.target) && e.target.nodeName !== "LI" && e.target.getAttribute("class") !== "input_checkbox") {
