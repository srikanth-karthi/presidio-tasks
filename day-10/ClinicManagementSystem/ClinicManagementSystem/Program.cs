...
namespace ClinicManagementSystem
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(ClinicService.DeleteDoctor(1));
            Console.WriteLine(ClinicService.GetDoctor(1));
            ...
            Console.WriteLine("\nAdding appointments:");
            Console.WriteLine(ClinicService.AddAppointment(new Appointment { Date = DateTime.Now, DoctorId = 2, PatientId = 1 }));
            Console.WriteLine(ClinicService.AddAppointment(new Appointment { Date = DateTime.Now.AddDays(1), DoctorId = 2, PatientId = 2 }));
